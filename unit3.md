...
// Така об'ява функції без її тіла дозволяє викликати її до її об'яви, 
...
> Перед тим як завантажувати даны впевныться в тому, що Ви правильно обрали плату та порт, а послідовний монітор є закритим.
